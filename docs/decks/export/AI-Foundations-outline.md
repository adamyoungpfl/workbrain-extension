...
Twenty years of web cookies: a dossier nobody authored, kept for someone else's purposes, invisible to the person it described. We ended up regulating it. Everybody remembers how that felt.
...
- **A credential** — A certificate at session four, and Work Brain Certified later for demonstrated use — verifiable, and it goes on a profile.
